...
CREATE INDEX IF NOT EXISTS "idx_oauth2_authorization_client_principal" ON "oauth2_authorization" ("registered_client_id", "principal_name");
...
CREATE INDEX IF NOT EXISTS "idx_sys_tenant_package" ON "sys_tenant" ("package_id");
...
CREATE INDEX IF NOT EXISTS "idx_sys_tenant_package_status" ON "sys_tenant_package" ("status");
...
CREATE INDEX IF NOT EXISTS "idx_sys_tenant_package_module_package" ON "sys_tenant_package_module" ("package_id");
CREATE INDEX IF NOT EXISTS "idx_sys_tenant_package_module_module" ON "sys_tenant_package_module" ("module_code");
...
CREATE INDEX IF NOT EXISTS "idx_sys_tenant_param_tenant_visible" ON "sys_tenant_param" ("tenant_id", "visible");
...
CREATE INDEX IF NOT EXISTS "idx_sys_menu_tenant_parent" ON "sys_menu" ("tenant_id", "parent_id");
CREATE INDEX IF NOT EXISTS "idx_sys_menu_tenant_permission" ON "sys_menu" ("tenant_id", "permission");
...
CREATE INDEX IF NOT EXISTS "idx_sys_org_tenant_parent" ON "sys_org" ("tenant_id", "parent_id");
CREATE INDEX IF NOT EXISTS "idx_sys_org_tenant_status" ON "sys_org" ("tenant_id", "status");
...
CREATE INDEX IF NOT EXISTS "idx_sys_post_tenant_org" ON "sys_post" ("tenant_id", "org_id");
CREATE INDEX IF NOT EXISTS "idx_sys_post_tenant_status" ON "sys_post" ("tenant_id", "status");
...
CREATE INDEX IF NOT EXISTS "idx_sys_user_post_tenant_post" ON "sys_user_post" ("tenant_id", "post_id");
CREATE INDEX IF NOT EXISTS "idx_sys_user_post_tenant_primary" ON "sys_user_post" ("tenant_id", "user_id", "primary_flag");
...
CREATE INDEX IF NOT EXISTS "idx_sys_admin_scope_user" ON "sys_admin_scope" ("tenant_id", "user_id");
CREATE INDEX IF NOT EXISTS "idx_sys_admin_scope_ref" ON "sys_admin_scope" ("tenant_id", "scope_type", "scope_ref_code");
...
CREATE INDEX IF NOT EXISTS "idx_sys_role_menu_tenant_menu" ON "sys_role_menu" ("tenant_id", "menu_id");
...
CREATE INDEX IF NOT EXISTS "idx_sys_role_data_scope_org" ON "sys_role_data_scope" ("tenant_id", "org_id");
...
CREATE INDEX IF NOT EXISTS "idx_sys_login_log_tenant_created" ON "sys_login_log" ("tenant_id", "created_at");
CREATE INDEX IF NOT EXISTS "idx_sys_login_log_tenant_user" ON "sys_login_log" ("tenant_id", "user_id");
CREATE INDEX IF NOT EXISTS "idx_sys_login_log_tenant_result" ON "sys_login_log" ("tenant_id", "result");
...
CREATE INDEX IF NOT EXISTS "idx_sys_exception_log_tenant_created" ON "sys_exception_log" ("tenant_id", "created_at");
CREATE INDEX IF NOT EXISTS "idx_sys_exception_log_tenant_trace" ON "sys_exception_log" ("tenant_id", "trace_id");
CREATE INDEX IF NOT EXISTS "idx_sys_exception_log_tenant_exception" ON "sys_exception_log" ("tenant_id", "exception_name");
...
CREATE INDEX IF NOT EXISTS "idx_sys_permission_audit_tenant_created" ON "sys_permission_audit" ("tenant_id", "created_at");
CREATE INDEX IF NOT EXISTS "idx_sys_permission_audit_tenant_operator" ON "sys_permission_audit" ("tenant_id", "operator_id");
CREATE INDEX IF NOT EXISTS "idx_sys_permission_audit_tenant_target" ON "sys_permission_audit" ("tenant_id", "target_type", "target_id");
...
CREATE INDEX IF NOT EXISTS "idx_sys_audit_log_tenant_created" ON "sys_audit_log" ("tenant_id", "created_at");
CREATE INDEX IF NOT EXISTS "idx_sys_audit_log_tenant_user" ON "sys_audit_log" ("tenant_id", "user_id");
CREATE INDEX IF NOT EXISTS "idx_sys_audit_log_tenant_action" ON "sys_audit_log" ("tenant_id", "action");
...
CREATE TABLE IF NOT EXISTS "sys_param" (
    ...
    "param_value" TEXT,
    "value_type" VARCHAR(32) NOT NULL DEFAULT 'string',
    "system_flag" BOOLEAN NOT NULL DEFAULT 0,
...
CREATE INDEX IF NOT EXISTS "idx_sys_param_tenant_system" ON "sys_param" ("tenant_id", "system_flag");
...
CREATE INDEX IF NOT EXISTS "idx_sys_secret_tenant_status" ON "sys_secret" ("tenant_id", "status");
CREATE INDEX IF NOT EXISTS "idx_sys_secret_tenant_kind" ON "sys_secret" ("tenant_id", "secret_kind");
CREATE INDEX IF NOT EXISTS "idx_sys_secret_tenant_expire" ON "sys_secret" ("tenant_id", "expire_at");
...
CREATE INDEX IF NOT EXISTS "idx_sys_access_restriction_active" ON "sys_access_restriction" ("tenant_id", "restriction_type", "start_at", "end_at");
...
CREATE TABLE IF NOT EXISTS "sys_password_policy" (
    ...
    "require_uppercase" BOOLEAN NOT NULL DEFAULT 0,
    "require_lowercase" BOOLEAN NOT NULL DEFAULT 1,
    "require_digit" BOOLEAN NOT NULL DEFAULT 1,
...
CREATE INDEX IF NOT EXISTS "idx_sys_password_policy_tenant_enabled" ON "sys_password_policy" ("tenant_id", "enabled");
...
CREATE INDEX IF NOT EXISTS "idx_sys_code_rule_tenant_enabled" ON "sys_code_rule" ("tenant_id", "enabled");
...
CREATE INDEX IF NOT EXISTS "idx_sys_dict_type_tenant_status" ON "sys_dict_type" ("tenant_id", "status");
...
CREATE INDEX IF NOT EXISTS "idx_sys_dict_item_tenant_code_sort" ON "sys_dict_item" ("tenant_id", "dict_code", "sort_order");
...
CREATE INDEX IF NOT EXISTS "idx_sys_module_type_enabled" ON "sys_module" ("module_type", "enabled");
...
CREATE INDEX IF NOT EXISTS "idx_sys_module_dep_depends_on" ON "sys_module_dependency" ("depends_on_code");
...
CREATE INDEX IF NOT EXISTS "idx_sys_module_resource_type" ON "sys_module_resource" ("resource_type", "resource_code");
...
CREATE INDEX IF NOT EXISTS "idx_lowcode_ds_tenant_enabled" ON "lowcode_data_source" ("tenant_id", "enabled");
...
CREATE INDEX IF NOT EXISTS "idx_lowcode_table_tenant_status" ON "lowcode_table_model" ("tenant_id", "status");
CREATE INDEX IF NOT EXISTS "idx_lowcode_table_data_source" ON "lowcode_table_model" ("data_source_id");
...
CREATE TABLE IF NOT EXISTS "lowcode_column_model" (
    ...
    "length_value" INTEGER DEFAULT NULL,
    "scale_value" INTEGER DEFAULT NULL,
    "required" BOOLEAN NOT NULL DEFAULT 0,
    "primary_key_flag" BOOLEAN NOT NULL DEFAULT 0,
    "auto_increment_flag" BOOLEAN NOT NULL DEFAULT 0,
    "list_visible" BOOLEAN NOT NULL DEFAULT 0,
    "form_visible" BOOLEAN NOT NULL DEFAULT 0,
...
CREATE INDEX IF NOT EXISTS "idx_lowcode_column_table_sort" ON "lowcode_column_model" ("table_model_id", "sort_order");
...
CREATE INDEX IF NOT EXISTS "idx_lowcode_relation_tenant_main" ON "lowcode_table_relation" ("tenant_id", "main_table_id");
CREATE INDEX IF NOT EXISTS "idx_lowcode_relation_tenant_sub" ON "lowcode_table_relation" ("tenant_id", "sub_table_id");
...
CREATE INDEX IF NOT EXISTS "idx_lowcode_page_tenant_table" ON "lowcode_page_model" ("tenant_id", "table_model_id");
...
CREATE TABLE IF NOT EXISTS "lowcode_generation_record" (
    ...
    "file_manifest_json" TEXT DEFAULT NULL,
...
CREATE INDEX IF NOT EXISTS "idx_lowcode_gen_tenant_model" ON "lowcode_generation_record" ("tenant_id", "table_model_code");
CREATE INDEX IF NOT EXISTS "idx_lowcode_gen_tenant_status" ON "lowcode_generation_record" ("tenant_id", "status");
CREATE INDEX IF NOT EXISTS "idx_lowcode_gen_target" ON "lowcode_generation_record" ("target");
...
CREATE INDEX IF NOT EXISTS "idx_lc_gen_file_tenant_record" ON "lc_generation_file" ("tenant_id", "record_id");
CREATE INDEX IF NOT EXISTS "idx_lc_gen_file_hash" ON "lc_generation_file" ("content_hash");
...
CREATE INDEX IF NOT EXISTS "idx_wf_category_tenant_status" ON "wf_category" ("tenant_id", "status");
...
CREATE INDEX IF NOT EXISTS "idx_wf_model_tenant_category" ON "wf_process_model" ("tenant_id", "category_id");
CREATE INDEX IF NOT EXISTS "idx_wf_model_tenant_status" ON "wf_process_model" ("tenant_id", "status");
...
CREATE INDEX IF NOT EXISTS "idx_wf_form_binding_tenant_module" ON "wf_form_binding" ("tenant_id", "business_module");
CREATE INDEX IF NOT EXISTS "idx_wf_form_binding_tenant_status" ON "wf_form_binding" ("tenant_id", "status");
...
CREATE INDEX IF NOT EXISTS "idx_wf_definition_tenant_key" ON "wf_process_definition" ("tenant_id", "process_key");
CREATE INDEX IF NOT EXISTS "idx_wf_definition_tenant_status" ON "wf_process_definition" ("tenant_id", "status");
...
CREATE INDEX IF NOT EXISTS "idx_wf_pi_tenant_business" ON "wf_process_instance" ("tenant_id", "business_key");
CREATE INDEX IF NOT EXISTS "idx_wf_pi_tenant_status" ON "wf_process_instance" ("tenant_id", "status");
...
CREATE INDEX IF NOT EXISTS "idx_wf_task_tenant_assignee" ON "wf_task" ("tenant_id", "assignee_user_id", "status");
CREATE INDEX IF NOT EXISTS "idx_wf_task_tenant_instance" ON "wf_task" ("tenant_id", "process_instance_id");
...
CREATE INDEX IF NOT EXISTS "idx_wf_record_tenant_task" ON "wf_approval_record" ("tenant_id", "task_id");
CREATE INDEX IF NOT EXISTS "idx_wf_record_tenant_instance" ON "wf_approval_record" ("tenant_id", "process_instance_id");
...
CREATE INDEX IF NOT EXISTS "idx_wf_cc_tenant_receiver" ON "wf_cc_record" ("tenant_id", "receiver_id", "read_flag");
CREATE INDEX IF NOT EXISTS "idx_wf_cc_tenant_instance" ON "wf_cc_record" ("tenant_id", "process_instance_id");
...
CREATE TABLE IF NOT EXISTS "act_hi_actinst" (
    ...
    "TRANSACTION_ORDER_" INTEGER DEFAULT NULL,
...
CREATE INDEX IF NOT EXISTS "ACT_FK_INFO_JSON_BA" ON "act_procdef_info" ("INFO_JSON_ID_");
...
CREATE INDEX IF NOT EXISTS "ACT_FK_MODEL_SOURCE" ON "act_re_model" ("EDITOR_SOURCE_VALUE_ID_");
CREATE INDEX IF NOT EXISTS "ACT_FK_MODEL_SOURCE_EXTRA" ON "act_re_model" ("EDITOR_SOURCE_EXTRA_VALUE_ID_");
CREATE INDEX IF NOT EXISTS "ACT_FK_MODEL_DEPLOYMENT" ON "act_re_model" ("DEPLOYMENT_ID_");
...
CREATE TABLE IF NOT EXISTS "act_ru_execution" (
    ...
    "EVT_SUBSCR_COUNT_" INTEGER DEFAULT NULL,
    "TASK_COUNT_" INTEGER DEFAULT NULL,
    "JOB_COUNT_" INTEGER DEFAULT NULL,
    "TIMER_JOB_COUNT_" INTEGER DEFAULT NULL,
    "SUSP_JOB_COUNT_" INTEGER DEFAULT NULL,
    "DEADLETTER_JOB_COUNT_" INTEGER DEFAULT NULL,
    "EXTERNAL_WORKER_JOB_COUNT_" INTEGER DEFAULT NULL,
    "VAR_COUNT_" INTEGER DEFAULT NULL,
    "ID_LINK_COUNT_" INTEGER DEFAULT NULL,
    "CALLBACK_ID_" varchar(255) DEFAULT NULL,
    "CALLBACK_TYPE_" varchar(255) DEFAULT NULL,
    "REFERENCE_ID_" varchar(255) DEFAULT NULL,
    "REFERENCE_TYPE_" varchar(255) DEFAULT NULL,
...
CREATE INDEX IF NOT EXISTS "ACT_FK_EXE_PROCINST" ON "act_ru_execution" ("PROC_INST_ID_");
CREATE INDEX IF NOT EXISTS "ACT_FK_EXE_PARENT" ON "act_ru_execution" ("PARENT_ID_");
CREATE INDEX IF NOT EXISTS "ACT_FK_EXE_SUPER" ON "act_ru_execution" ("SUPER_EXEC_");
CREATE INDEX IF NOT EXISTS "ACT_FK_EXE_PROCDEF" ON "act_ru_execution" ("PROC_DEF_ID_");
...
CREATE TABLE IF NOT EXISTS "act_ru_deadletter_job" (
    ...
    "CATEGORY_" varchar(255) DEFAULT NULL,
    "TYPE_" varchar(255) NOT NULL,
    "EXCLUSIVE_" BOOLEAN DEFAULT NULL,
    "EXECUTION_ID_" varchar(64) DEFAULT NULL,
...
CREATE INDEX IF NOT EXISTS "ACT_FK_DEADLETTER_JOB_EXECUTION" ON "act_ru_deadletter_job" ("EXECUTION_ID_");
CREATE INDEX IF NOT EXISTS "ACT_FK_DEADLETTER_JOB_PROCESS_INSTANCE" ON "act_ru_deadletter_job" ("PROCESS_INSTANCE_ID_");
CREATE INDEX IF NOT EXISTS "ACT_FK_DEADLETTER_JOB_PROC_DEF" ON "act_ru_deadletter_job" ("PROC_DEF_ID_");
...
CREATE TABLE IF NOT EXISTS "act_ru_task" (
    ...
    "VAR_COUNT_" INTEGER DEFAULT NULL,
    "ID_LINK_COUNT_" INTEGER DEFAULT NULL,
    "SUB_TASK_COUNT_" INTEGER DEFAULT NULL,
    PRIMARY KEY ("ID_"),
...
CREATE INDEX IF NOT EXISTS "ACT_FK_TASK_EXE" ON "act_ru_task" ("EXECUTION_ID_");
CREATE INDEX IF NOT EXISTS "ACT_FK_TASK_PROCINST" ON "act_ru_task" ("PROC_INST_ID_");
CREATE INDEX IF NOT EXISTS "ACT_FK_TASK_PROCDEF" ON "act_ru_task" ("PROC_DEF_ID_");
...
CREATE INDEX IF NOT EXISTS "ACT_FK_TSKASS_TASK" ON "act_ru_identitylink" ("TASK_ID_");
CREATE INDEX IF NOT EXISTS "ACT_FK_IDL_PROCINST" ON "act_ru_identitylink" ("PROC_INST_ID_");
...
CREATE INDEX IF NOT EXISTS "ACT_FK_JOB_EXECUTION" ON "act_ru_job" ("EXECUTION_ID_");
CREATE INDEX IF NOT EXISTS "ACT_FK_JOB_PROCESS_INSTANCE" ON "act_ru_job" ("PROCESS_INSTANCE_ID_");
CREATE INDEX IF NOT EXISTS "ACT_FK_JOB_PROC_DEF" ON "act_ru_job" ("PROC_DEF_ID_");
...
CREATE INDEX IF NOT EXISTS "ACT_FK_SUSPENDED_JOB_EXECUTION" ON "act_ru_suspended_job" ("EXECUTION_ID_");
CREATE INDEX IF NOT EXISTS "ACT_FK_SUSPENDED_JOB_PROCESS_INSTANCE" ON "act_ru_suspended_job" ("PROCESS_INSTANCE_ID_");
CREATE INDEX IF NOT EXISTS "ACT_FK_SUSPENDED_JOB_PROC_DEF" ON "act_ru_suspended_job" ("PROC_DEF_ID_");
...
CREATE INDEX IF NOT EXISTS "ACT_FK_TIMER_JOB_EXECUTION" ON "act_ru_timer_job" ("EXECUTION_ID_");
CREATE INDEX IF NOT EXISTS "ACT_FK_TIMER_JOB_PROCESS_INSTANCE" ON "act_ru_timer_job" ("PROCESS_INSTANCE_ID_");
CREATE INDEX IF NOT EXISTS "ACT_FK_TIMER_JOB_PROC_DEF" ON "act_ru_timer_job" ("PROC_DEF_ID_");
...
CREATE INDEX IF NOT EXISTS "ACT_FK_VAR_BYTEARRAY" ON "act_ru_variable" ("BYTEARRAY_ID_");
CREATE INDEX IF NOT EXISTS "ACT_IDX_VARIABLE_TASK_ID" ON "act_ru_variable" ("TASK_ID_");
CREATE INDEX IF NOT EXISTS "ACT_FK_VAR_EXE" ON "act_ru_variable" ("EXECUTION_ID_");
CREATE INDEX IF NOT EXISTS "ACT_FK_VAR_PROCINST" ON "act_ru_variable" ("PROC_INST_ID_");
...
CREATE INDEX IF NOT EXISTS "idx_openapi_app_tenant_owner" ON "openapi_app" ("tenant_id", "owner_user_id");
CREATE INDEX IF NOT EXISTS "idx_openapi_app_tenant_status" ON "openapi_app" ("tenant_id", "status");
...
CREATE INDEX IF NOT EXISTS "idx_openapi_api_key_tenant_app" ON "openapi_api_key" ("tenant_id", "app_code");
CREATE INDEX IF NOT EXISTS "idx_openapi_api_key_tenant_status" ON "openapi_api_key" ("tenant_id", "status");
...
CREATE INDEX IF NOT EXISTS "idx_openapi_api_permission_app_path" ON "openapi_api_permission" ("tenant_id", "app_code", "http_method", "path_pattern");
CREATE INDEX IF NOT EXISTS "idx_openapi_api_permission_app_status" ON "openapi_api_permission" ("tenant_id", "app_code", "status");
...
CREATE INDEX IF NOT EXISTS "idx_openapi_oauth_client_app_status" ON "openapi_oauth_client" ("tenant_id", "app_code", "status");
...
CREATE INDEX IF NOT EXISTS "idx_openapi_catalog_group_status" ON "openapi_catalog" ("group_code", "status");
CREATE INDEX IF NOT EXISTS "idx_openapi_catalog_method_path" ON "openapi_catalog" ("http_method", "path_pattern");
...
CREATE INDEX IF NOT EXISTS "idx_openapi_version_api_status" ON "openapi_version" ("api_code", "status");
...
CREATE INDEX IF NOT EXISTS "idx_openapi_signature_policy_app_status" ON "openapi_signature_policy" ("tenant_id", "app_code", "status");
...
CREATE INDEX IF NOT EXISTS "idx_openapi_rate_limit_policy_app_status" ON "openapi_rate_limit_policy" ("tenant_id", "app_code", "status");
...
CREATE INDEX IF NOT EXISTS "idx_openapi_rate_limit_counter_expires" ON "openapi_rate_limit_counter" ("expires_at");
...
CREATE INDEX IF NOT EXISTS "idx_openapi_replay_nonce_expires" ON "openapi_replay_nonce" ("expires_at");
...
CREATE INDEX IF NOT EXISTS "idx_openapi_call_audit_app_called" ON "openapi_call_audit" ("tenant_id", "app_code", "called_at");
CREATE INDEX IF NOT EXISTS "idx_openapi_call_audit_app_api" ON "openapi_call_audit" ("tenant_id", "app_code", "api_code");
CREATE INDEX IF NOT EXISTS "idx_openapi_call_audit_request_id" ON "openapi_call_audit" ("request_id");
...
CREATE INDEX IF NOT EXISTS "idx_ai_provider_tenant_status" ON "ai_provider" ("tenant_id", "status");
...
CREATE TABLE IF NOT EXISTS "ai_model_config" (
    ...
    "support_stream" BOOLEAN NOT NULL DEFAULT 1,
    "support_tool" BOOLEAN NOT NULL DEFAULT 0,
    "status" VARCHAR(32) NOT NULL DEFAULT 'enabled',
    "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY ("id"),
...
CREATE INDEX IF NOT EXISTS "idx_ai_model_tenant_provider" ON "ai_model_config" ("tenant_id", "provider_id");
CREATE INDEX IF NOT EXISTS "idx_ai_model_tenant_status" ON "ai_model_config" ("tenant_id", "status");
...
CREATE INDEX IF NOT EXISTS "idx_ai_app_tenant_status" ON "ai_app" ("tenant_id", "status");
CREATE INDEX IF NOT EXISTS "idx_ai_app_default_model" ON "ai_app" ("default_model_id");
...
CREATE INDEX IF NOT EXISTS "idx_ai_prompt_tenant_status" ON "ai_prompt_template" ("tenant_id", "status");
...
CREATE INDEX IF NOT EXISTS "idx_ai_audit_tenant_app_time" ON "ai_invocation_audit" ("tenant_id", "app_code", "created_at");
CREATE INDEX IF NOT EXISTS "idx_ai_audit_tenant_model_time" ON "ai_invocation_audit" ("tenant_id", "model_id", "created_at");
CREATE INDEX IF NOT EXISTS "idx_ai_audit_trace" ON "ai_invocation_audit" ("trace_id");
...
CREATE INDEX IF NOT EXISTS "idx_msg_template_tenant_status" ON "msg_template" ("tenant_id", "status");
...
CREATE INDEX IF NOT EXISTS "idx_msg_message_tenant_receiver" ON "msg_message" ("tenant_id", "receiver_id", "read_flag", "created_at");
CREATE INDEX IF NOT EXISTS "idx_msg_message_tenant_type" ON "msg_message" ("tenant_id", "message_type");
...
CREATE INDEX IF NOT EXISTS "idx_file_storage_config_tenant_status" ON "file_storage_config" ("tenant_id", "status");
CREATE INDEX IF NOT EXISTS "idx_file_storage_config_tenant_default" ON "file_storage_config" ("tenant_id", "default_flag");
...
CREATE INDEX IF NOT EXISTS "idx_file_object_tenant_storage" ON "file_object" ("tenant_id", "storage_code");
CREATE INDEX IF NOT EXISTS "idx_file_object_tenant_created" ON "file_object" ("tenant_id", "created_at");
CREATE INDEX IF NOT EXISTS "idx_file_object_tenant_status" ON "file_object" ("tenant_id", "file_status");
...
CREATE INDEX IF NOT EXISTS "idx_file_preview_log_tenant_file" ON "file_preview_log" ("tenant_id", "file_code");
CREATE INDEX IF NOT EXISTS "idx_file_preview_log_created_at" ON "file_preview_log" ("created_at");
...
CREATE INDEX IF NOT EXISTS "idx_cms_channel_tenant_status" ON "cms_channel" ("tenant_id", "channel_status");
...
CREATE INDEX IF NOT EXISTS "idx_cms_content_tenant_channel" ON "cms_content" ("tenant_id", "channel_code");
CREATE INDEX IF NOT EXISTS "idx_cms_content_tenant_status" ON "cms_content" ("tenant_id", "content_status");
...
CREATE INDEX IF NOT EXISTS "idx_job_task_tenant_status" ON "job_task" ("tenant_id", "job_status");
...
CREATE INDEX IF NOT EXISTS "idx_job_task_log_tenant_job" ON "job_task_log" ("tenant_id", "job_id", "start_at");
...
CREATE INDEX IF NOT EXISTS "idx_search_index_config_tenant_status" ON "search_index_config" ("tenant_id", "index_status");
...
CREATE INDEX IF NOT EXISTS "idx_search_rebuild_task_tenant_index" ON "search_rebuild_task" ("tenant_id", "index_code");
CREATE INDEX IF NOT EXISTS "idx_search_rebuild_task_status" ON "search_rebuild_task" ("task_status");
...
CREATE INDEX IF NOT EXISTS "idx_search_query_log_tenant_index" ON "search_query_log" ("tenant_id", "index_code");
...
CREATE INDEX IF NOT EXISTS "idx_visual_dataset_tenant_status" ON "visual_dataset" ("tenant_id", "dataset_status");
...
CREATE INDEX IF NOT EXISTS "idx_visual_report_tenant_status" ON "visual_report" ("tenant_id", "report_status");
CREATE INDEX IF NOT EXISTS "idx_visual_report_tenant_dataset" ON "visual_report" ("tenant_id", "dataset_code");
...
CREATE INDEX IF NOT EXISTS "idx_visual_screen_tenant_status" ON "visual_screen" ("tenant_id", "screen_status");
...
CREATE INDEX IF NOT EXISTS "idx_i18n_message_tenant_locale_status" ON "i18n_message" ("tenant_id", "locale", "message_status");
...
CREATE INDEX IF NOT EXISTS "idx_pur_request_tenant_applicant" ON "pur_request" ("tenant_id", "applicant_id");
CREATE INDEX IF NOT EXISTS "idx_pur_request_tenant_status" ON "pur_request" ("tenant_id", "process_status");
CREATE INDEX IF NOT EXISTS "idx_pur_request_tenant_process" ON "pur_request" ("tenant_id", "process_instance_id");
...
CREATE INDEX IF NOT EXISTS "idx_pur_order_tenant_request" ON "pur_order" ("tenant_id", "request_no");
CREATE INDEX IF NOT EXISTS "idx_pur_order_tenant_status" ON "pur_order" ("tenant_id", "order_status");
...
CREATE INDEX IF NOT EXISTS "idx_pur_order_item_tenant_order" ON "pur_order_item" ("tenant_id", "order_no");
