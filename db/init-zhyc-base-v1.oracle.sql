...
CREATE TABLE "oauth2_registered_client" (
    ...
    "post_logout_redirect_uris" VARCHAR2(1000) DEFAULT NULL,
...
CREATE TABLE "oauth2_authorization" (
    ...
    "authorized_scopes" VARCHAR2(1000) DEFAULT NULL,
...
CREATE TABLE "sys_tenant" (
    ...
    "tenant_name" VARCHAR2(128) NOT NULL,
    "package_id" NUMBER(19) DEFAULT NULL,
    "isolation_mode" VARCHAR2(32) NOT NULL DEFAULT 'TENANT_COLUMN',
    "status" VARCHAR2(32) NOT NULL DEFAULT 'enabled',
...
CREATE TABLE "sys_tenant_package" (
    ...
    "status" VARCHAR2(32) NOT NULL DEFAULT 'enabled',
    "max_user_count" NUMBER(10) NOT NULL DEFAULT 0,
    "max_storage_mb" NUMBER(10) NOT NULL DEFAULT 0,
    "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY ("id"),
...
CREATE TABLE "sys_tenant_package_module" (
    ...
    "menu_code" VARCHAR2(64) DEFAULT NULL,
    "permission" VARCHAR2(128) DEFAULT NULL,
    "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY ("id"),
...
CREATE TABLE "sys_tenant_param" (
    ...
    "param_value" VARCHAR2(1000) DEFAULT NULL,
    "value_type" VARCHAR2(32) NOT NULL DEFAULT 'string',
...
CREATE TABLE "sys_role" (
    ...
    "data_scope" VARCHAR2(32) NOT NULL DEFAULT 'SELF',
    "status" VARCHAR2(32) NOT NULL DEFAULT 'enabled',
    "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY ("id"),
...
CREATE TABLE "sys_org" (
    ...
    "tenant_id" VARCHAR2(64) NOT NULL,
    "parent_id" NUMBER(19) DEFAULT NULL,
    "ancestors" VARCHAR2(500) NOT NULL DEFAULT '0',
    "org_code" VARCHAR2(64) NOT NULL,
    "org_name" VARCHAR2(128) NOT NULL,
    "leader_user_id" NUMBER(19) DEFAULT NULL,
    "sort_order" NUMBER(10) NOT NULL DEFAULT 0,
    "status" VARCHAR2(32) NOT NULL DEFAULT 'enabled',
    "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE "sys_post" (
    "id" NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    "tenant_id" VARCHAR2(64) NOT NULL,
    "org_id" NUMBER(19) DEFAULT NULL,
    "post_code" VARCHAR2(64) NOT NULL,
    "post_name" VARCHAR2(128) NOT NULL,
    "sort_order" NUMBER(10) NOT NULL DEFAULT 0,
    "status" VARCHAR2(32) NOT NULL DEFAULT 'enabled',
    "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE "sys_admin_scope" (
    ...
    "scope_ref_code" VARCHAR2(128) NOT NULL,
    "scope_name" VARCHAR2(128) DEFAULT NULL,
    "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY ("id"),
...
CREATE TABLE "sys_role_data_scope" (
    ...
    "scope_type" VARCHAR2(32) NOT NULL DEFAULT 'org',
    "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY ("id"),
...
CREATE TABLE "sys_login_log" (
    ...
    "login_type" VARCHAR2(32) NOT NULL,
    "result" VARCHAR2(32) NOT NULL,
    "client_ip" VARCHAR2(64) DEFAULT NULL,
    "user_agent" VARCHAR2(512) DEFAULT NULL,
    "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY ("id")
);
...
CREATE TABLE "sys_permission_audit" (
    "id" NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    "tenant_id" VARCHAR2(64) NOT NULL,
    "operator_id" NUMBER(19) DEFAULT NULL,
    "target_type" VARCHAR2(64) NOT NULL,
    "target_id" VARCHAR2(128) NOT NULL,
    "before_value" CLOB,
    "after_value" CLOB,
    "change_type" VARCHAR2(64) NOT NULL,
    "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY ("id")
);
...
CREATE TABLE "sys_audit_log" (
    ...
    "target_type" VARCHAR2(64) DEFAULT NULL,
    "target_id" VARCHAR2(128) DEFAULT NULL,
    "result" VARCHAR2(32) NOT NULL,
    "client_ip" VARCHAR2(64) DEFAULT NULL,
    "detail" CLOB,
    "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE "sys_secret" (
    "id" NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    "tenant_id" VARCHAR2(64) NOT NULL,
    "secret_code" VARCHAR2(64) NOT NULL,
    "secret_name" VARCHAR2(128) NOT NULL,
    "secret_kind" VARCHAR2(64) NOT NULL,
    "secret_cipher" CLOB NOT NULL,
    "secret_mask" VARCHAR2(255) NOT NULL,
    "status" VARCHAR2(32) NOT NULL DEFAULT 'enabled',
    "expire_at" TIMESTAMP DEFAULT NULL,
...
CREATE TABLE "sys_access_restriction" (
    "id" NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    "tenant_id" VARCHAR2(64) NOT NULL,
    "restriction_type" VARCHAR2(32) NOT NULL,
    "rule_value" VARCHAR2(255) NOT NULL,
    "effect" VARCHAR2(32) NOT NULL,
...
CREATE TABLE "sys_password_policy" (
    ...
    "min_length" NUMBER(10) NOT NULL DEFAULT 8,
    ...
    "history_count" NUMBER(10) NOT NULL DEFAULT 3,
    "max_retry_count" NUMBER(10) NOT NULL DEFAULT 5,
    "lock_minutes" NUMBER(10) NOT NULL DEFAULT 30,
...
CREATE TABLE "sys_code_rule" (
    ...
    "prefix" VARCHAR2(32) DEFAULT NULL,
    "date_pattern" VARCHAR2(32) DEFAULT NULL,
    "sequence_length" NUMBER(10) NOT NULL DEFAULT 5,
    "current_value" NUMBER(10) NOT NULL DEFAULT 0,
    "enabled" NUMBER(1) NOT NULL DEFAULT 1,
    "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY ("id"),
...
CREATE TABLE "sys_dict_item" (
    ...
    "item_color" VARCHAR2(32) DEFAULT NULL,
    "sort_order" NUMBER(10) NOT NULL DEFAULT 0,
    "status" VARCHAR2(32) NOT NULL DEFAULT 'enabled',
    "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE "sys_module_dependency" (
    "id" NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    "module_code" VARCHAR2(64) NOT NULL,
    "depends_on_code" VARCHAR2(64) NOT NULL,
    "required_version" VARCHAR2(32) DEFAULT NULL,
    "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY ("id"),
...
CREATE TABLE "sys_module_resource" (
    ...
    "resource_path" VARCHAR2(255) DEFAULT NULL,
    "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY ("id"),
...
CREATE TABLE "lowcode_data_source" (
    ...
    "name" VARCHAR2(128) NOT NULL,
    "dialect" VARCHAR2(32) NOT NULL,
    "jdbc_url" VARCHAR2(512) NOT NULL,
    "username" VARCHAR2(128) NOT NULL,
    "password_secret_ref" VARCHAR2(255) DEFAULT NULL,
    "enabled" NUMBER(1) NOT NULL DEFAULT 1,
    "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY ("id"),
...
CREATE TABLE "lowcode_table_model" (
    "id" NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    "tenant_id" VARCHAR2(64) NOT NULL,
    "data_source_id" NUMBER(19) DEFAULT NULL,
    "code" VARCHAR2(64) NOT NULL,
    "name" VARCHAR2(128) NOT NULL,
    "table_name" VARCHAR2(128) NOT NULL,
    "status" VARCHAR2(32) NOT NULL DEFAULT 'DRAFT',
    "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY ("id"),
...
CREATE TABLE "lowcode_column_model" (
    "id" NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    "table_model_id" NUMBER(19) NOT NULL,
    "code" VARCHAR2(64) NOT NULL,
    "name" VARCHAR2(128) NOT NULL,
    "field_type" VARCHAR2(32) NOT NULL,
    "length_value" NUMBER(10) DEFAULT NULL,
    "scale_value" NUMBER(10) DEFAULT NULL,
    ...
    "dict_code" VARCHAR2(64) DEFAULT NULL,
    "sort_order" NUMBER(10) NOT NULL DEFAULT 0,
...
CREATE TABLE "lowcode_table_relation" (
    "id" NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    "tenant_id" VARCHAR2(64) NOT NULL,
    "main_table_id" NUMBER(19) NOT NULL,
    "sub_table_id" NUMBER(19) NOT NULL,
    "relation_type" VARCHAR2(32) NOT NULL,
    "join_column" VARCHAR2(64) NOT NULL,
    "ref_column" VARCHAR2(64) NOT NULL,
    "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY ("id"),
...
CREATE TABLE "lowcode_page_model" (
    ...
    "tenant_id" VARCHAR2(64) NOT NULL,
    "table_model_id" NUMBER(19) NOT NULL,
    "page_type" VARCHAR2(32) NOT NULL,
    "route_path" VARCHAR2(255) NOT NULL,
    "component_path" VARCHAR2(255) NOT NULL,
    "layout_type" VARCHAR2(64) NOT NULL,
    "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY ("id"),
...
CREATE TABLE "lowcode_generation_record" (
    "id" NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    "tenant_id" VARCHAR2(64) NOT NULL,
    "table_model_code" VARCHAR2(64) NOT NULL,
    "target" VARCHAR2(32) NOT NULL,
    "module_name" VARCHAR2(128) NOT NULL,
    "entity_name" VARCHAR2(128) NOT NULL,
    "overwrite_strategy" VARCHAR2(32) NOT NULL,
...
CREATE TABLE "lc_generation_file" (
    ...
    "overwrite_mode" VARCHAR2(32) NOT NULL,
...
CREATE TABLE "wf_process_model" (
    ...
    "flowable_model_id" VARCHAR2(128) NOT NULL,
...
CREATE TABLE "wf_form_binding" (
    ...
    "business_module" VARCHAR2(64) NOT NULL,
    "business_table" VARCHAR2(128) NOT NULL,
    "form_route" VARCHAR2(255) NOT NULL,
    "mobile_route" VARCHAR2(255) NULL,
    "status" VARCHAR2(32) NOT NULL DEFAULT 'enabled',
    "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "deleted" NUMBER(3) NOT NULL DEFAULT 0,
...
CREATE TABLE "wf_process_instance" (
    ...
    "starter_user_id" NUMBER(19) NULL,
    "status" VARCHAR2(32) NOT NULL,
...
CREATE TABLE "wf_approval_record" (
    ...
    "tenant_id" VARCHAR2(64) NOT NULL,
    "task_id" VARCHAR2(128) NOT NULL,
    "process_instance_id" VARCHAR2(128) NULL,
    "operator_user_id" NUMBER(19) NOT NULL,
    "action" VARCHAR2(32) NOT NULL,
    "approval_comment" VARCHAR2(1000) NULL,
...
CREATE TABLE "act_evt_log" (
    ...
    "USER_ID_" VARCHAR2(255) DEFAULT NULL,
    "DATA_" BLOB,
    "LOCK_OWNER_" VARCHAR2(255) DEFAULT NULL,
...
CREATE TABLE "act_re_deployment" (
    ...
    "DERIVED_FROM_" VARCHAR2(64) DEFAULT NULL,
    "DERIVED_FROM_ROOT_" VARCHAR2(64) DEFAULT NULL,
    "PARENT_DEPLOYMENT_ID_" VARCHAR2(255) DEFAULT NULL,
...
CREATE TABLE "act_ge_property" (
    ...
    "VALUE_" VARCHAR2(300) DEFAULT NULL,
    "REV_" NUMBER(10) DEFAULT NULL,
    PRIMARY KEY ("NAME_")
);
...
CREATE TABLE "act_hi_actinst" (
    ...
    "TASK_ID_" VARCHAR2(64) DEFAULT NULL,
    "CALL_PROC_INST_ID_" VARCHAR2(64) DEFAULT NULL,
    "ACT_NAME_" VARCHAR2(255) DEFAULT NULL,
    "ACT_TYPE_" VARCHAR2(255) NOT NULL,
    "ASSIGNEE_" VARCHAR2(255) DEFAULT NULL,
    "COMPLETED_BY_" VARCHAR2(255) DEFAULT NULL,
    "START_TIME_" TIMESTAMP(3) NOT NULL,
    "END_TIME_" TIMESTAMP(3) DEFAULT NULL,
    "TRANSACTION_ORDER_" NUMBER(10) DEFAULT NULL,
...
CREATE TABLE "act_hi_attachment" (
    ...
    "TASK_ID_" VARCHAR2(64) DEFAULT NULL,
    "PROC_INST_ID_" VARCHAR2(64) DEFAULT NULL,
    "URL_" VARCHAR2(4000) DEFAULT NULL,
    "CONTENT_ID_" VARCHAR2(64) DEFAULT NULL,
...
CREATE TABLE "act_hi_comment" (
    ...
    "TASK_ID_" VARCHAR2(64) DEFAULT NULL,
    "PROC_INST_ID_" VARCHAR2(64) DEFAULT NULL,
    "ACTION_" VARCHAR2(255) DEFAULT NULL,
...
CREATE TABLE "act_hi_detail" (
    ...
    "VAR_TYPE_" VARCHAR2(255) DEFAULT NULL,
    "REV_" NUMBER(10) DEFAULT NULL,
    "TIME_" TIMESTAMP(3) NOT NULL,
    "BYTEARRAY_ID_" VARCHAR2(64) DEFAULT NULL,
    "DOUBLE_" DOUBLE PRECISION DEFAULT NULL,
    "LONG_" NUMBER(19) DEFAULT NULL,
    "TEXT_" VARCHAR2(4000) DEFAULT NULL,
    "TEXT2_" VARCHAR2(4000) DEFAULT NULL,
    PRIMARY KEY ("ID_")
);
...
CREATE TABLE "act_hi_entitylink" (
    "ID_" VARCHAR2(64) NOT NULL,
    "LINK_TYPE_" VARCHAR2(255) DEFAULT NULL,
    "CREATE_TIME_" TIMESTAMP(3) DEFAULT NULL,
    "SCOPE_ID_" VARCHAR2(255) DEFAULT NULL,
    "SUB_SCOPE_ID_" VARCHAR2(255) DEFAULT NULL,
    "SCOPE_TYPE_" VARCHAR2(255) DEFAULT NULL,
    "SCOPE_DEFINITION_ID_" VARCHAR2(255) DEFAULT NULL,
    "PARENT_ELEMENT_ID_" VARCHAR2(255) DEFAULT NULL,
    "REF_SCOPE_ID_" VARCHAR2(255) DEFAULT NULL,
    "REF_SCOPE_TYPE_" VARCHAR2(255) DEFAULT NULL,
    "REF_SCOPE_DEFINITION_ID_" VARCHAR2(255) DEFAULT NULL,
    "ROOT_SCOPE_ID_" VARCHAR2(255) DEFAULT NULL,
    "ROOT_SCOPE_TYPE_" VARCHAR2(255) DEFAULT NULL,
    "HIERARCHY_TYPE_" VARCHAR2(255) DEFAULT NULL,
    PRIMARY KEY ("ID_")
);
...
CREATE TABLE "act_hi_identitylink" (
    "ID_" VARCHAR2(64) NOT NULL,
    "GROUP_ID_" VARCHAR2(255) DEFAULT NULL,
    "TYPE_" VARCHAR2(255) DEFAULT NULL,
    "USER_ID_" VARCHAR2(255) DEFAULT NULL,
    "TASK_ID_" VARCHAR2(64) DEFAULT NULL,
    "CREATE_TIME_" TIMESTAMP(3) DEFAULT NULL,
...
CREATE TABLE "act_hi_procinst" (
    ...
    "TENANT_ID_" VARCHAR2(255) DEFAULT '',
    "NAME_" VARCHAR2(255) DEFAULT NULL,
    "CALLBACK_ID_" VARCHAR2(255) DEFAULT NULL,
    "CALLBACK_TYPE_" VARCHAR2(255) DEFAULT NULL,
    "REFERENCE_ID_" VARCHAR2(255) DEFAULT NULL,
    "REFERENCE_TYPE_" VARCHAR2(255) DEFAULT NULL,
    "PROPAGATED_STAGE_INST_ID_" VARCHAR2(255) DEFAULT NULL,
    "BUSINESS_STATUS_" VARCHAR2(255) DEFAULT NULL,
    "END_USER_ID_" VARCHAR2(255) DEFAULT NULL,
    "STATE_" VARCHAR2(255) DEFAULT NULL,
    PRIMARY KEY ("ID_"),
...
CREATE TABLE "act_hi_taskinst" (
    ...
    "REV_" NUMBER(10) DEFAULT '1',
    "PROC_DEF_ID_" VARCHAR2(64) DEFAULT NULL,
    "TASK_DEF_ID_" VARCHAR2(64) DEFAULT NULL,
    ...
    "IN_PROGRESS_STARTED_BY_" VARCHAR2(255) DEFAULT NULL,
    "CLAIM_TIME_" TIMESTAMP(3) DEFAULT NULL,
    "CLAIMED_BY_" VARCHAR2(255) DEFAULT NULL,
    "SUSPENDED_TIME_" TIMESTAMP(3) DEFAULT NULL,
    "SUSPENDED_BY_" VARCHAR2(255) DEFAULT NULL,
    "END_TIME_" TIMESTAMP(3) DEFAULT NULL,
    "COMPLETED_BY_" VARCHAR2(255) DEFAULT NULL,
    "DURATION_" NUMBER(19) DEFAULT NULL,
    "DELETE_REASON_" VARCHAR2(4000) DEFAULT NULL,
    ...
    "FORM_KEY_" VARCHAR2(255) DEFAULT NULL,
    "CATEGORY_" VARCHAR2(255) DEFAULT NULL,
    "TENANT_ID_" VARCHAR2(255) DEFAULT '',
...
CREATE TABLE "act_hi_tsk_log" (
    ...
    "USER_ID_" VARCHAR2(255) DEFAULT NULL,
    "DATA_" VARCHAR2(4000) DEFAULT NULL,
    "EXECUTION_ID_" VARCHAR2(64) DEFAULT NULL,
    "PROC_INST_ID_" VARCHAR2(64) DEFAULT NULL,
    "PROC_DEF_ID_" VARCHAR2(64) DEFAULT NULL,
    "SCOPE_ID_" VARCHAR2(255) DEFAULT NULL,
...
CREATE TABLE "act_hi_varinst" (
    ...
    "TASK_ID_" VARCHAR2(64) DEFAULT NULL,
    "NAME_" VARCHAR2(255) NOT NULL,
    "VAR_TYPE_" VARCHAR2(100) DEFAULT NULL,
    "SCOPE_ID_" VARCHAR2(255) DEFAULT NULL,
    "SUB_SCOPE_ID_" VARCHAR2(255) DEFAULT NULL,
    "SCOPE_TYPE_" VARCHAR2(255) DEFAULT NULL,
    "BYTEARRAY_ID_" VARCHAR2(64) DEFAULT NULL,
    ...
    "TEXT_" VARCHAR2(4000) DEFAULT NULL,
    "TEXT2_" VARCHAR2(4000) DEFAULT NULL,
    "META_INFO_" VARCHAR2(4000) DEFAULT NULL,
    "CREATE_TIME_" TIMESTAMP(3) DEFAULT NULL,
    "LAST_UPDATED_TIME_" TIMESTAMP(3) DEFAULT NULL,
    PRIMARY KEY ("ID_")
);
...
CREATE TABLE "act_re_procdef" (
    ...
    "DEPLOYMENT_ID_" VARCHAR2(64) DEFAULT NULL,
    "RESOURCE_NAME_" VARCHAR2(4000) DEFAULT NULL,
    "DGRM_RESOURCE_NAME_" VARCHAR2(4000) DEFAULT NULL,
    "DESCRIPTION_" VARCHAR2(4000) DEFAULT NULL,
    "HAS_START_FORM_KEY_" NUMBER(3) DEFAULT NULL,
    "HAS_GRAPHICAL_NOTATION_" NUMBER(3) DEFAULT NULL,
    "SUSPENSION_STATE_" NUMBER(10) DEFAULT NULL,
    "TENANT_ID_" VARCHAR2(255) DEFAULT '',
    "ENGINE_VERSION_" VARCHAR2(255) DEFAULT NULL,
    "DERIVED_FROM_" VARCHAR2(64) DEFAULT NULL,
    "DERIVED_FROM_ROOT_" VARCHAR2(64) DEFAULT NULL,
...
CREATE TABLE "act_procdef_info" (
    ...
    "PROC_DEF_ID_" VARCHAR2(64) NOT NULL,
    "REV_" NUMBER(10) DEFAULT NULL,
    "INFO_JSON_ID_" VARCHAR2(64) DEFAULT NULL,
    PRIMARY KEY ("ID_"),
...
CREATE TABLE "act_re_model" (
    ...
    "META_INFO_" VARCHAR2(4000) DEFAULT NULL,
    "DEPLOYMENT_ID_" VARCHAR2(64) DEFAULT NULL,
    "EDITOR_SOURCE_VALUE_ID_" VARCHAR2(64) DEFAULT NULL,
    "EDITOR_SOURCE_EXTRA_VALUE_ID_" VARCHAR2(64) DEFAULT NULL,
    "TENANT_ID_" VARCHAR2(255) DEFAULT '',
    PRIMARY KEY ("ID_"),
...
CREATE TABLE "act_ru_execution" (
    ...
    "PROC_DEF_ID_" VARCHAR2(64) DEFAULT NULL,
    "SUPER_EXEC_" VARCHAR2(64) DEFAULT NULL,
    "ROOT_PROC_INST_ID_" VARCHAR2(64) DEFAULT NULL,
    "ACT_ID_" VARCHAR2(255) DEFAULT NULL,
    ...
    "SUSPENSION_STATE_" NUMBER(10) DEFAULT NULL,
    "CACHED_ENT_STATE_" NUMBER(10) DEFAULT NULL,
    "TENANT_ID_" VARCHAR2(255) DEFAULT '',
    "NAME_" VARCHAR2(255) DEFAULT NULL,
    "START_ACT_ID_" VARCHAR2(255) DEFAULT NULL,
    ...
    "EVT_SUBSCR_COUNT_" NUMBER(10) DEFAULT NULL,
    "TASK_COUNT_" NUMBER(10) DEFAULT NULL,
    "JOB_COUNT_" NUMBER(10) DEFAULT NULL,
    "TIMER_JOB_COUNT_" NUMBER(10) DEFAULT NULL,
    "SUSP_JOB_COUNT_" NUMBER(10) DEFAULT NULL,
    "DEADLETTER_JOB_COUNT_" NUMBER(10) DEFAULT NULL,
    "EXTERNAL_WORKER_JOB_COUNT_" NUMBER(10) DEFAULT NULL,
    "VAR_COUNT_" NUMBER(10) DEFAULT NULL,
    "ID_LINK_COUNT_" NUMBER(10) DEFAULT NULL,
    "CALLBACK_ID_" VARCHAR2(255) DEFAULT NULL,
    "CALLBACK_TYPE_" VARCHAR2(255) DEFAULT NULL,
    "REFERENCE_ID_" VARCHAR2(255) DEFAULT NULL,
    "REFERENCE_TYPE_" VARCHAR2(255) DEFAULT NULL,
...
CREATE TABLE "act_ru_deadletter_job" (
    ...
    "EXECUTION_ID_" VARCHAR2(64) DEFAULT NULL,
    "PROCESS_INSTANCE_ID_" VARCHAR2(64) DEFAULT NULL,
    "PROC_DEF_ID_" VARCHAR2(64) DEFAULT NULL,
    "ELEMENT_ID_" VARCHAR2(255) DEFAULT NULL,
    "ELEMENT_NAME_" VARCHAR2(255) DEFAULT NULL,
    "SCOPE_ID_" VARCHAR2(255) DEFAULT NULL,
    "SUB_SCOPE_ID_" VARCHAR2(255) DEFAULT NULL,
    "SCOPE_TYPE_" VARCHAR2(255) DEFAULT NULL,
    "SCOPE_DEFINITION_ID_" VARCHAR2(255) DEFAULT NULL,
    "CORRELATION_ID_" VARCHAR2(255) DEFAULT NULL,
    "EXCEPTION_STACK_ID_" VARCHAR2(64) DEFAULT NULL,
    "EXCEPTION_MSG_" VARCHAR2(4000) DEFAULT NULL,
    "DUEDATE_" TIMESTAMP(3) NULL DEFAULT NULL,
    "REPEAT_" VARCHAR2(255) DEFAULT NULL,
    "HANDLER_TYPE_" VARCHAR2(255) DEFAULT NULL,
    "HANDLER_CFG_" VARCHAR2(4000) DEFAULT NULL,
    "CUSTOM_VALUES_ID_" VARCHAR2(64) DEFAULT NULL,
    "CREATE_TIME_" TIMESTAMP(3) NULL DEFAULT NULL,
    "TENANT_ID_" VARCHAR2(255) DEFAULT '',
    PRIMARY KEY ("ID_"),
...
CREATE TABLE "act_ru_event_subscr" (
    ...
    "EVENT_NAME_" VARCHAR2(255) DEFAULT NULL,
    "EXECUTION_ID_" VARCHAR2(64) DEFAULT NULL,
    "PROC_INST_ID_" VARCHAR2(64) DEFAULT NULL,
    "ACTIVITY_ID_" VARCHAR2(64) DEFAULT NULL,
    "CONFIGURATION_" VARCHAR2(255) DEFAULT NULL,
    "CREATED_" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    "PROC_DEF_ID_" VARCHAR2(64) DEFAULT NULL,
    "SUB_SCOPE_ID_" VARCHAR2(64) DEFAULT NULL,
    "SCOPE_ID_" VARCHAR2(64) DEFAULT NULL,
    "SCOPE_DEFINITION_ID_" VARCHAR2(64) DEFAULT NULL,
    "SCOPE_DEFINITION_KEY_" VARCHAR2(255) DEFAULT NULL,
    "SCOPE_TYPE_" VARCHAR2(64) DEFAULT NULL,
    "LOCK_TIME_" TIMESTAMP(3) NULL DEFAULT NULL,
    "LOCK_OWNER_" VARCHAR2(255) DEFAULT NULL,
    "TENANT_ID_" VARCHAR2(255) DEFAULT '',
    PRIMARY KEY ("ID_"),
...
CREATE TABLE "act_ru_external_job" (
    ...
    "SCOPE_DEFINITION_ID_" VARCHAR2(255) DEFAULT NULL,
    "CORRELATION_ID_" VARCHAR2(255) DEFAULT NULL,
    "RETRIES_" NUMBER(10) DEFAULT NULL,
    "EXCEPTION_STACK_ID_" VARCHAR2(64) DEFAULT NULL,
    "EXCEPTION_MSG_" VARCHAR2(4000) DEFAULT NULL,
    "DUEDATE_" TIMESTAMP(3) NULL DEFAULT NULL,
    "REPEAT_" VARCHAR2(255) DEFAULT NULL,
...
CREATE TABLE "act_ru_history_job" (
    ...
    "HANDLER_CFG_" VARCHAR2(4000) DEFAULT NULL,
    "CUSTOM_VALUES_ID_" VARCHAR2(64) DEFAULT NULL,
    "ADV_HANDLER_CFG_ID_" VARCHAR2(64) DEFAULT NULL,
    "CREATE_TIME_" TIMESTAMP(3) NULL DEFAULT NULL,
    "SCOPE_TYPE_" VARCHAR2(255) DEFAULT NULL,
    "TENANT_ID_" VARCHAR2(255) DEFAULT '',
    PRIMARY KEY ("ID_")
...
CREATE TABLE "act_ru_task" (
    ...
    "OWNER_" VARCHAR2(255) DEFAULT NULL,
    "ASSIGNEE_" VARCHAR2(255) DEFAULT NULL,
    "DELEGATION_" VARCHAR2(64) DEFAULT NULL,
    "PRIORITY_" NUMBER(10) DEFAULT NULL,
    "CREATE_TIME_" TIMESTAMP(3) NULL DEFAULT NULL,
    "IN_PROGRESS_TIME_" TIMESTAMP(3) DEFAULT NULL,
    "IN_PROGRESS_STARTED_BY_" VARCHAR2(255) DEFAULT NULL,
    ...
    "VAR_COUNT_" NUMBER(10) DEFAULT NULL,
    "ID_LINK_COUNT_" NUMBER(10) DEFAULT NULL,
    "SUB_TASK_COUNT_" NUMBER(10) DEFAULT NULL,
    PRIMARY KEY ("ID_"),
...
CREATE TABLE "flw_ru_batch" (
    ...
    "SEARCH_KEY_" VARCHAR2(255) DEFAULT NULL,
    "SEARCH_KEY2_" VARCHAR2(255) DEFAULT NULL,
    "CREATE_TIME_" TIMESTAMP(3) NOT NULL,
    "COMPLETE_TIME_" TIMESTAMP(3) DEFAULT NULL,
    "STATUS_" VARCHAR2(255) DEFAULT NULL,
    "BATCH_DOC_ID_" VARCHAR2(64) DEFAULT NULL,
    "TENANT_ID_" VARCHAR2(255) DEFAULT '',
    PRIMARY KEY ("ID_")
);
...
CREATE TABLE "flw_ru_batch_part" (
    "ID_" VARCHAR2(64) NOT NULL,
    "REV_" NUMBER(10) DEFAULT NULL,
    "BATCH_ID_" VARCHAR2(64) DEFAULT NULL,
    "TYPE_" VARCHAR2(64) NOT NULL,
    "SCOPE_ID_" VARCHAR2(64) DEFAULT NULL,
    "SUB_SCOPE_ID_" VARCHAR2(64) DEFAULT NULL,
    "SCOPE_TYPE_" VARCHAR2(64) DEFAULT NULL,
    ...
    "COMPLETE_TIME_" TIMESTAMP(3) DEFAULT NULL,
    "STATUS_" VARCHAR2(255) DEFAULT NULL,
    "RESULT_DOC_ID_" VARCHAR2(64) DEFAULT NULL,
    "TENANT_ID_" VARCHAR2(255) DEFAULT '',
    PRIMARY KEY ("ID_"),
...
CREATE TABLE "openapi_api_key" (
    ...
    "tenant_id" VARCHAR2(64) NOT NULL,
    "app_code" VARCHAR2(64) NOT NULL,
    "access_key" VARCHAR2(128) NOT NULL,
    "secret_cipher" VARCHAR2(512) NOT NULL,
    "status" VARCHAR2(32) NOT NULL DEFAULT 'enabled',
    "expire_at" TIMESTAMP,
    "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE "openapi_api_permission" (
    ...
    "tenant_id" VARCHAR2(64) NOT NULL,
    "app_code" VARCHAR2(64) NOT NULL,
    "api_code" VARCHAR2(128) NOT NULL,
    "api_name" VARCHAR2(128) NOT NULL,
    "http_method" VARCHAR2(16) NOT NULL,
    "path_pattern" VARCHAR2(256) NOT NULL,
    "status" VARCHAR2(32) NOT NULL DEFAULT 'enabled',
    "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY ("id"),
...
CREATE TABLE "openapi_oauth_client" (
    ...
    "allowed_scopes" VARCHAR2(512) NOT NULL,
    "status" VARCHAR2(32) NOT NULL DEFAULT 'enabled',
    "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY ("id"),
...
CREATE TABLE "openapi_version" (
    ...
    "api_code" VARCHAR2(128) NOT NULL,
    "version" VARCHAR2(32) NOT NULL,
    "backend_route" VARCHAR2(512) NOT NULL,
    "request_schema" JSON,
    "response_schema" JSON,
    "status" VARCHAR2(32) NOT NULL DEFAULT 'published',
    "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY ("id"),
...
CREATE TABLE "openapi_signature_policy" (
    ...
    "timestamp_tolerance_seconds" NUMBER(10) NOT NULL,
    "nonce_ttl_seconds" NUMBER(10) NOT NULL,
...
CREATE TABLE "openapi_rate_limit_counter" (
    ...
    "app_code" VARCHAR2(64) NOT NULL,
    "api_code" VARCHAR2(128) NOT NULL,
    "window_seconds" NUMBER(19) NOT NULL,
    "window_index" NUMBER(19) NOT NULL,
...
CREATE TABLE "openapi_replay_nonce" (
    "id" NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    "app_key" VARCHAR2(128) NOT NULL,
    "nonce_value" VARCHAR2(128) NOT NULL,
    "expires_at" TIMESTAMP NOT NULL,
    "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY ("id"),
...
CREATE TABLE "ai_provider" (
    ...
    "provider_type" VARCHAR2(64) NOT NULL,
...
CREATE TABLE "ai_app" (
    ...
    "app_code" VARCHAR2(64) NOT NULL,
    "app_name" VARCHAR2(128) NOT NULL,
    "default_model_id" NUMBER(19) NOT NULL,
    "system_prompt" CLOB NOT NULL,
    "daily_token_quota" NUMBER(10) NOT NULL DEFAULT 100000,
    "status" VARCHAR2(32) NOT NULL DEFAULT 'enabled',
    "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY ("id"),
...
CREATE TABLE "ai_prompt_template" (
    "id" NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    "tenant_id" VARCHAR2(64) NOT NULL,
    "prompt_code" VARCHAR2(64) NOT NULL,
    "prompt_name" VARCHAR2(128) NOT NULL,
    "version" VARCHAR2(32) NOT NULL,
    "template_content" CLOB NOT NULL,
    "variables" VARCHAR2(1000) DEFAULT NULL,
    "status" VARCHAR2(32) NOT NULL DEFAULT 'draft',
    "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY ("id"),
...
CREATE TABLE "ai_invocation_audit" (
    ...
    "invocation_type" VARCHAR2(32) NOT NULL,
    "prompt_tokens" NUMBER(10) NOT NULL DEFAULT 0,
    "completion_tokens" NUMBER(10) NOT NULL DEFAULT 0,
    "total_tokens" NUMBER(10) NOT NULL DEFAULT 0,
    "latency_ms" NUMBER(19) NOT NULL DEFAULT 0,
    "status" VARCHAR2(32) NOT NULL,
    "error_message" VARCHAR2(1000) DEFAULT NULL,
    "trace_id" VARCHAR2(128) DEFAULT NULL,
    "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE "msg_message" (
    "id" NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    "tenant_id" VARCHAR2(64) NOT NULL,
    "message_code" VARCHAR2(64) NOT NULL,
    "receiver_id" NUMBER(19) NOT NULL,
    "receiver_name" VARCHAR2(128) NULL,
...
CREATE TABLE "file_storage_config" (
    "id" NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    "tenant_id" VARCHAR2(64) NOT NULL,
    "storage_code" VARCHAR2(64) NOT NULL,
    "storage_name" VARCHAR2(128) NOT NULL,
...
CREATE TABLE "file_preview_log" (
    ...
    "tenant_id" VARCHAR2(64) NOT NULL,
    "file_code" VARCHAR2(64) NOT NULL,
    "preview_type" VARCHAR2(32) NOT NULL,
    "preview_url" VARCHAR2(512) NOT NULL,
    "result" VARCHAR2(32) NOT NULL,
    "cost_ms" NUMBER(19) NOT NULL DEFAULT 0,
    "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY ("id")
);
...
CREATE TABLE "cms_channel" (
    ...
    "sort_order" NUMBER(10) NOT NULL DEFAULT 0,
    "channel_status" VARCHAR2(32) NOT NULL DEFAULT 'enabled',
    "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "deleted" NUMBER(3) NOT NULL DEFAULT 0,
    PRIMARY KEY ("id"),
...
CREATE TABLE "cms_content" (
    ...
    "content_status" VARCHAR2(32) NOT NULL DEFAULT 'draft',
...
CREATE TABLE "job_task" (
    ...
    "handler_name" VARCHAR2(128) NOT NULL,
    "job_description" VARCHAR2(500) NULL,
    "job_status" VARCHAR2(32) NOT NULL DEFAULT 'disabled',
    "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "deleted" NUMBER(3) NOT NULL DEFAULT 0,
    PRIMARY KEY ("id"),
...
CREATE TABLE "search_index_config" (
    ...
    "tenant_id" VARCHAR2(64) NOT NULL,
    "index_code" VARCHAR2(128) NOT NULL,
    "index_name" VARCHAR2(128) NOT NULL,
    "source_table" VARCHAR2(128) NOT NULL,
    "search_fields" VARCHAR2(512) NOT NULL,
    "filter_fields" VARCHAR2(512) DEFAULT NULL,
    "index_status" VARCHAR2(32) NOT NULL DEFAULT 'enabled',
...
CREATE TABLE "search_rebuild_task" (
    ...
    "tenant_id" VARCHAR2(64) NOT NULL,
    "index_code" VARCHAR2(128) NOT NULL,
    "task_status" VARCHAR2(32) NOT NULL DEFAULT 'pending',
    "trigger_type" VARCHAR2(32) NOT NULL DEFAULT 'manual',
...
CREATE TABLE "search_query_log" (
    ...
    "result_count" NUMBER(10) NOT NULL DEFAULT 0,
    "cost_ms" NUMBER(19) NOT NULL DEFAULT 0,
    "query_status" VARCHAR2(32) NOT NULL DEFAULT 'success',
    "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE "visual_dataset" (
    "id" NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    "tenant_id" VARCHAR2(64) NOT NULL,
    "dataset_code" VARCHAR2(64) NOT NULL,
    "dataset_name" VARCHAR2(128) NOT NULL,
    "datasource_code" VARCHAR2(64) NOT NULL,
    "sql_text" CLOB NOT NULL,
    "dataset_status" VARCHAR2(32) NOT NULL DEFAULT 'enabled',
    "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "deleted" NUMBER(3) NOT NULL DEFAULT 0,
    PRIMARY KEY ("id"),
...
CREATE TABLE "visual_report" (
    ...
    "dataset_code" VARCHAR2(64) NOT NULL,
    "chart_type" VARCHAR2(32) NOT NULL DEFAULT 'table',
    "config_json" CLOB NOT NULL,
    "report_status" VARCHAR2(32) NOT NULL DEFAULT 'enabled',
    "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "deleted" NUMBER(3) NOT NULL DEFAULT 0,
    PRIMARY KEY ("id"),
...
CREATE TABLE "visual_screen" (
    "id" NUMBER(19) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    "tenant_id" VARCHAR2(64) NOT NULL,
    "screen_code" VARCHAR2(64) NOT NULL,
    "screen_name" VARCHAR2(128) NOT NULL,
    "layout_json" CLOB NOT NULL,
    "screen_status" VARCHAR2(32) NOT NULL DEFAULT 'draft',
    "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "deleted" NUMBER(3) NOT NULL DEFAULT 0,
    PRIMARY KEY ("id"),
...
CREATE TABLE "i18n_message" (
    ...
    "message_key" VARCHAR2(190) NOT NULL,
    "message_value" VARCHAR2(1000) NOT NULL,
    "message_status" VARCHAR2(32) NOT NULL DEFAULT 'enabled',
    "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "deleted" NUMBER(3) NOT NULL DEFAULT 0,
    PRIMARY KEY ("id"),
...
CREATE TABLE "pur_request" (
    ...
    "request_title" VARCHAR2(128) NOT NULL,
    "applicant_id" NUMBER(19) NOT NULL,
    "org_id" NUMBER(19) NOT NULL,
    "total_amount" DECIMAL(18,2) NOT NULL DEFAULT 0.00,
    "request_reason" VARCHAR2(1000) NULL,
