 ...
 * 系统登录日志接口契约测试。
 */
class SysLoginLogControllerContractTest {

    /**
     * 验证登录日志控制器暴露最近日志查询路由，并声明 Shiro 权限。
     *
     * @throws Exception 反射读取控制器失败时抛出
     */
    @Test
    void shouldExposeRecentLoginLogsRouteWithShiroPermission() throws Exception {
        Class<?> controllerClass = Class.forName("com.zhyc.system.loginlog.controller.SysLoginLogController");
