...
class SysOrgControllerContractTest {
    ...
    /**
     * 验证组织控制器暴露组织树路由，并声明 Shiro 权限。
     *
     * @throws Exception 反射读取控制器失败时抛出
     */
    @Test
    void shouldExposeOrgTreeRouteWithShiroPermission() throws Exception {
        Class<?> controllerClass = Class.forName("com.zhyc.system.org.controller.SysOrgController");
