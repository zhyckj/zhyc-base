...
package com.zhyc.workflow.support;
 ...
 * 工作流服务层通用参数校验工具。
 *
 * <p>用于把工作流服务面向调用方的参数和业务错误统一转换为稳定业务异常，避免审批接口暴露 Java 异常类型。</p>
 */
public final class WorkflowServiceValidation {

  /** 工作流通用参数错误码。 */
  public static final String ERROR_ARGUMENT_INVALID = "ZHYC_WORKFLOW_ARGUMENT_INVALID";

  private WorkflowServiceValidation() {
  }
   ...
   * @return 非空长整型
   */
  public static Long requireLong(Long value, String message) {
    if (value == null) {
      throw businessFailure(message);
    }
    return value;
