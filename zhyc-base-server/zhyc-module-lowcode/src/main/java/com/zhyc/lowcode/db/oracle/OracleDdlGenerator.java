 ...
 * Oracle DDL 生成器。
 */
public class OracleDdlGenerator implements DdlGenerator {
   ...
   */
  public OracleDdlGenerator(FieldTypeMapper fieldTypeMapper) {
  ...
  public String generateCreateTable(LowcodeTable table) {
    ...
    ddl.append("    CONSTRAINT ")
        ...
        .append(" PRIMARY KEY (")
        .append(DdlGenerationSupport.primaryKeys(columns, OracleDdlGenerator::quote))
        .append(")\n);");
