...
public class OpenApiCallAuditResponse {
     ...
     * @param calledAt 调用时间
     */
    public OpenApiCallAuditResponse(String accessKey, String apiCode, String httpMethod, String requestPath,
                                    Integer responseStatus, Long durationMs, Integer success, String errorCode,
                                    String clientIp, String requestId, LocalDateTime calledAt) {
